...
module FFMPEG
  class Raw
    def initialize(cliargs,output_file)
      @cliargs = cliargs
    ...
    def run
      ...
      command = "#{FFMPEG.ffmpeg_binary}  #{@cliargs} #{Shellwords.escape(@output_file)}"
      ...
      if encoding_succeeded?
        ...
        FFMPEG.logger.info "Transcoding with #{@cliargs} to #{@output_file} succeeded\n"
      else
